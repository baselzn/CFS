...
class document_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_document_submitted', 'caadocapproval');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' submitted the document with id '$this->objectid' for approval";
    }
